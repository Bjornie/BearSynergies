...
function syn.buildMenu()
	...
	local options = {
		...
		},
		{
			...
			tooltip = "Enabling this will prevent you from being able to take the Harvest synergy from the Healing Seed warden skill.",
			default = true,
		...
		{
			type = "checkbox",
			name = "Disable Bone Shield",
			tooltip = "Enabling this will prevent you from being able to take the Bone Shield and Bone Surge synergies from the Bone Shield and morphs undaunted skill.",
			default = true,
