---------- DRAGONKNIGHT ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_SHACKLE", "Shackle")
ZO_CreateStringId("SI_SYNERGY_ABILITY_IGNITE", "Ignite")

---------- NECROMANCER ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_BONEYARD", "Grave Robber")

---------- NIGHTBLADE ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_HIDDEN_REFRESH", "Hidden Refresh")
ZO_CreateStringId("SI_SYNERGY_ABILITY_SOUL_LEECH", "Soul Leech")
...
---------- TEMPLAR ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_BLESSED_SHARDS", "Blessed Shards")
ZO_CreateStringId("SI_SYNERGY_ABILITY_HOLY_SHARDS", "Holy Shards")
ZO_CreateStringId("SI_SYNERGY_ABILITY_SUPERNOVA", "Supernova")
ZO_CreateStringId("SI_SYNERGY_ABILITY_GRAVITY_CRUSH", "Gravity Crush")
ZO_CreateStringId("SI_SYNERGY_ABILITY_PURIFY", "Purify")

---------- WARDEN ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_HARVEST", "Harvest")
ZO_CreateStringId("SI_SYNERGY_ABILITY_ESCAPE", "Escape")

---------- WEREWOLF ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_FEEDING_FRENZY", "Feeding Frenzy")

---------- UNDAUNTED ----------
ZO_CreateStringId("SI_SYNERGY_ABILITY_BLOOD_FUNNEL", "Blood Funnel")
ZO_CreateStringId("SI_SYNERGY_ABILITY_BLOOD_FEAST", "Blood Feast")
ZO_CreateStringId("SI_SYNERGY_ABILITY_SPAWN_BROODLINGS", "Spawn Broodlings")
ZO_CreateStringId("SI_SYNERGY_ABILITY_BLACK_WIDOWS", "Black Widows")
ZO_CreateStringId("SI_SYNERGY_ABILITY_ARACHNOPHOBIA", "Arachnophobia")
ZO_CreateStringId("SI_SYNERGY_ABILITY_RADIATE", "Radiate")
ZO_CreateStringId("SI_SYNERGY_ABILITY_BONE_WALL", "Bone Wall")
ZO_CreateStringId("SI_SYNERGY_ABILITY_SPINAL_SURGE", "Spinal Surge")
ZO_CreateStringId("SI_SYNERGY_ABILITY_COMBUSTION", "Combustion")
ZO_CreateStringId("SI_SYNERGY_ABILITY_HEALING_COMBUSTION", "Healing Combustion")
